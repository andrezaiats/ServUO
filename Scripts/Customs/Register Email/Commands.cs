...
public class EmailCommands
{
    public static void Initialize()
    {
        ...
        //Admin Commands
        CommandSystem.Register("sendemailX", AccessLevel.Seer, new CommandEventHandler(Send_Email));
        CommandSystem.Register("clearemailsX", AccessLevel.Seer, new CommandEventHandler(Clear_Emails));
    }
